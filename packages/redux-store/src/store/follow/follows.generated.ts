...
export type AllPagesByFollowingQueryVariables = Types.Exact<{
  after?: Types.InputMaybe<Types.Scalars['String']>;
  before?: Types.InputMaybe<Types.Scalars['String']>;
  first?: Types.InputMaybe<Types.Scalars['Int']>;
  last?: Types.InputMaybe<Types.Scalars['Int']>;
...
export type AllPagesByFollowingQuery = {
  __typename?: 'Query';
  allPagesByFollowing: {
...
export const CheckIfFollowPageDocument = `
  ...
  checkIfFollowPage(pageId: $pageId)
    ...
    `;
export const AllPagesByFollowingDocument = `
    query allPagesByFollowing($after: String, $before: String, $first: Int = 20, $last: Int, $orderBy: PageOrder, $skip: Int) {
  allPagesByFollowing(
    after: $after
    before: $before
    first: $first
...
const injectedRtkApi = api.injectEndpoints({
  endpoints: build => ({
    ...
    allPagesByFollowing: build.query<AllPagesByFollowingQuery, AllPagesByFollowingQueryVariables | void>({
      query: variables => ({ document: AllPagesByFollowingDocument, variables })
    }),
...
export const {
  ...
  useAllPagesByFollowingQuery,
  useLazyAllPagesByFollowingQuery,
