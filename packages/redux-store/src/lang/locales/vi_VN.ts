...
export default {
  ...
  'account.accountChangeLocaleSuccess':
    'Ngôn ngữ được cập nhật thành Tiếng Việt.',
  ...
  'settings.grantPermisson':
    'Bạn sẽ được nhắc cấp quyền cho thông báo, Vui lòng nhấp vào "Cho phép"',
  'settings.ok': 'OK',
  ...
  'settings.deviceSupport':
    'Tính năng này hoạt động tốt nhất với Chrome hoặc Brave trên thiết bị Android',
  ...
  'settings.removeLanguageNotTrans':
    'Tất cả bài viết sẽ tự động dịch theo ngôn ngữ chính',
  'settings.lockAppDesc': 'Yêu cầu khoá ứng dụng',
  'settings.notificationsDesc': 'Cho phép thông báo',
  ...
  'send.syntaxError':
    'Lỗi cú pháp. XPI để tặng không được nhỏ hơn hoặc bằng 0 ',
  'send.sendXpi': ' Gửi',
