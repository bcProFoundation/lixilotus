 ...
 */
export const forwardConnectionArgs: GraphQLFieldConfigArgumentMap = Object.freeze({
  after: {
    type: GraphQLString,
 ...
 */
export const backwardConnectionArgs: GraphQLFieldConfigArgumentMap = Object.freeze({
  before: {
    type: GraphQLString,
