...
import type { Connection, ConnectionArguments, ConnectionCursor } from './connection';
 ...
 */
export function cursorForObjectInConnection<T>(data: ReadonlyArray<T>, object: T): ConnectionCursor | null {
