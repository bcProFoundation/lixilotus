...
export const burnForToken = createAction<{ id: string; burnType?: BurnType; burnUp: number; burnDown: number }>(
  'tokens/burnForToken'
);
export const burnForTokenFailure = createAction<{ id: string; burnType?: BurnType; burnUp: number; burnDown: number }>(
