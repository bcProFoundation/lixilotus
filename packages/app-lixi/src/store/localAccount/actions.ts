...
export const selectLocalUserAccountSuccess = createAction<{ account: LocalUserAccount; lixies: Lixi[] }>('localUserAccount/selectLocalUserAccountSuccess');
export const selectLocalUserAccountFailure = createAction<string>('localUserAccount/selectLocalUserAccountFailure');
