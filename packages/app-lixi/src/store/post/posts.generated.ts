...
export type PostsQueryVariables = Types.Exact<{
  ...
  filter?: Types.InputMaybe<Types.Scalars['Int']>;
}>;
...
export const PostsDocument = `
    query Posts($after: String, $before: String, $first: Int = 20, $last: Int, $orderBy: PostOrder, $query: String, $skip: Int, $filter: Int) {
  allPosts(
    after: $after
    before: $before
    first: $first
...
export const OrphanPostsDocument = `
    query OrphanPosts($after: String, $before: String, $first: Int = 20, $last: Int, $orderBy: PostOrder, $query: String, $skip: Int, $filter: Int) {
  allOrphanPosts(
    after: $after
    before: $before
    first: $first
...
export const PostsByPageIdDocument = `
    query PostsByPageId($after: String, $before: String, $first: Int = 20, $last: Int, $orderBy: PostOrder, $id: String, $skip: Int, $filter: Int) {
  allPostsByPageId(
    after: $after
    before: $before
    first: $first
...
export const PostsByUserIdDocument = `
    query PostsByUserId($after: String, $before: String, $first: Int = 20, $last: Int, $orderBy: PostOrder, $id: String, $skip: Int, $filter: Int) {
  allPostsByUserId(
    after: $after
    before: $before
    first: $first
...
export const PostsByTokenIdDocument = `
    query PostsByTokenId($after: String, $before: String, $first: Int = 20, $last: Int, $orderBy: PostOrder, $id: String, $skip: Int, $filter: Int) {
  allPostsByTokenId(
    after: $after
    before: $before
    first: $first
...
export const PostsBySearchDocument = `
    query PostsBySearch($after: String, $before: String, $first: Int, $last: Int, $query: String, $filter: Int) {
  allPostsBySearch(
    after: $after
    before: $before
    first: $first
