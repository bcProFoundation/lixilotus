...
export const selectAccountSuccess = createAction<{ account: Account; lixies: Lixi[] }>(
...
export const importAccountSuccess = createAction<{ account: Account; lixies: Lixi[] }>(
...
export const refreshLixiListSuccess = createAction<{ account: Account; lixies: Lixi[] }>(
