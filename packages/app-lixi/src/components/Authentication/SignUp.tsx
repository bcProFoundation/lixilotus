  ...
  if (authentication) {
    signUpBody = (
      <div>
        ...
        <p>
          You will need to unlock with your <strong>fingerprint / device pin</strong> in order to access the wallet.
        </p>
        <p>
        ...
        <PrimaryButton onClick={handleSignUp}>Enable Lock</PrimaryButton>
        <SecondaryButton onClick={() => authentication.turnOffAuthentication()}>Skip</SecondaryButton>
      </div>
    );
  } else {
