...
export const basicMarksValue: any = (
  <fragment>
    ...
    <hh2>💧 Basic Marks</hh2>
    <hp>
      The basic marks consist of text formatting such as bold, italic, underline, strikethrough, subscript, superscript,
      and code.
    </hp>
    <hp>You can customize the type, the component and the hotkey for each of these.</hp>
    <hp>
