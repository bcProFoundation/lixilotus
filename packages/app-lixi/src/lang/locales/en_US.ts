...
export default {
  ...
  'account.equal': 'Equal',
  'account.package': 'Packages',
  'account.numberPerPackage': 'number of sub lixi per package',
  ...
  'lixi.numberPerPackage': 'Number of sub-lixi per package: {newNumberPerPackage}',
  'lixi.eachPackage': 'Number of sub-lixies for each package: ',
