...
export default {
  ...
  'account.package': 'Gói',
  'account.numberPerPackage': 'Số lượng bao lì xì phụ trong mỗi gói ',
  ...
  'lixi.numberPerPackage': 'Số lượng bao lì xì phụ trong mỗi gói: {newNumberPerPackage}',
  'lixi.eachPackage': 'Số lượng bao lì xì phụ cho mỗi gói: ',
